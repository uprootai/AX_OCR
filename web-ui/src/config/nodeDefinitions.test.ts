...
describe('nodeDefinitions', () => {
  ...
  describe('Node count verification', () => {
    it('should have exactly 35 node types', () => {
      // 34 이전 + 1 dimension_updater (크롭 업스케일)
    ...
    it('should have correct count per category', () => {
      ...
      expect(categoryCounts['analysis']).toBe(14);  // skinmodel, pidanalyzer, designchecker, pidcomposer, titleblock, partslist, dimensionparser, bommatcher, quotegenerator, gtcomparison, pdfexport, pidfeatures, verificationqueue, dimension_updater
