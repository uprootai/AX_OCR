    ...
    // ============ DSE BEARING TEMPLATES ============
    {
      ...
      workflow: {
        ...
        nodes: [
          ...
          { id: 'aibom_1', type: 'blueprint-ai-bom', label: '도면 검증 (AI BOM)', parameters: { drawing_type: 'dimension_bom', features: ['table_extraction', 'human_verification'] }, position: { x: 600, y: 200 } },
        ...
        edges: [
          ...
          { id: 'e5b', source: 'edocr2_1', target: 'skinmodel_1' },
    ...
    // DSE Bearing 2-1: Bearing Ring ASSY (T1-T8 시리즈)
    {
      ...
      workflow: {
        ...
        nodes: [
          ...
          { id: 'aibom_1', type: 'blueprint-ai-bom', label: 'BOM 검증 (AI BOM)', parameters: { drawing_type: 'assembly', features: ['table_extraction', 'dimension_verification'] }, position: { x: 750, y: 200 } },
        ...
        edges: [
          ...
          { id: 'e6b', source: 'edocr2_1', target: 'skinmodel_1' },
    ...
    // DSE Bearing 2-2: Bearing Casing ASSY
    {
      ...
      workflow: {
        ...
        nodes: [
          ...
          { id: 'aibom_1', type: 'blueprint-ai-bom', label: 'Casing 검증', parameters: { drawing_type: 'assembly', features: ['table_extraction', 'dimension_verification'] }, position: { x: 750, y: 200 } },
    ...
    // DSE Bearing 2-3: Thrust Bearing (TBN/GEN Side)
    {
      ...
      workflow: {
        ...
        nodes: [
          ...
          { id: 'tabledetector_1', type: 'table_detector', label: 'BOM 테이블 추출', parameters: { mode: 'extract', ocr_engine: 'paddle', borderless: false, confidence_threshold: 0.5, min_confidence: 50, crop_regions: ['title_block', 'revision_table', 'parts_list_right'], enable_quality_filter: true }, position: { x: 550, y: 100 } },
          ...
          { id: 'aibom_1', type: 'blueprint-ai-bom', label: 'Thrust BOM 검증', parameters: { drawing_type: 'assembly', features: ['table_extraction', 'dimension_verification', 'human_verification'] }, position: { x: 800, y: 200 } },
        ...
        edges: [
          ...
          { id: 'e7b', source: 'edocr2_1', target: 'skinmodel_1' },
