  ...
  const templates: TemplateInfo[] = [
    ...
    },
    {
      ...
      workflow: {
        ...
        description: 'Compare results from 4 different OCR engines',
        nodes: [
          ...
          { id: 'edocr2_1', type: 'edocr2', label: 'eDOCr2', parameters: {}, position: { x: 550, y: 80 } },
          { id: 'paddleocr_1', type: 'paddleocr', label: 'PaddleOCR', parameters: {}, position: { x: 550, y: 160 } },
          { id: 'tesseract_1', type: 'tesseract', label: 'Tesseract', parameters: {}, position: { x: 550, y: 240 } },
          { id: 'easyocr_1', type: 'easyocr', label: 'EasyOCR', parameters: { languages: ['en'] }, position: { x: 550, y: 320 } },
        ...
        edges: [
          ...
          { id: 'e5', source: 'yolo_1', target: 'easyocr_1' },
    ...
    },
    {
      ...
      workflow: {
        ...
        description: 'Use Vision-Language AI for context-aware analysis',
        nodes: [
          { id: 'imageinput_1', type: 'imageinput', label: 'Drawing Input', parameters: {}, position: { x: 100, y: 150 } },
        ...
        edges: [
          ...
          { id: 'e3', source: 'textinput_1', target: 'vl_1' },
          { id: 'e4', source: 'yolo_1', target: 'edocr2_1' },
          { id: 'e5', source: 'edocr2_1', target: 'merge_1' },
          { id: 'e6', source: 'vl_1', target: 'merge_1' },
        ],
      },
    },
