...
import { projectApi, type ProjectDetail, type ProjectUpdate } from '../../../lib/blueprintBomApi';
  ...
  useEffect(() => {
    if (isOpen) {
      setFormData({
        ...
        project_type: project.project_type === 'general' ? undefined : project.project_type,
