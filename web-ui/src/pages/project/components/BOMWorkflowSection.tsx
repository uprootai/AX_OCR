    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 mb-6">
                ...
                {idx < STEPS.length - 1 && (
                  <div
                    className={`w-8 h-0.5 mx-1 ${
                      idx < currentStep ? 'bg-green-400 dark:bg-green-500' : 'bg-gray-200 dark:bg-gray-600'
                    }`}
                  />
                )}
              </div>
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
        <button
          ...
          className="flex items-center gap-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-30"
        >
        ...
        <button
          ...
          className="flex items-center gap-1 px-4 py-2 bg-blue-500 dark:bg-blue-600 text-white rounded-lg text-sm hover:bg-blue-600 dark:hover:bg-blue-700 transition-colors disabled:opacity-30"
        >
          다음
