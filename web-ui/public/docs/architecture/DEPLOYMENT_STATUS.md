...
7개의 독립적인 마이크로서비스 API가 Docker 컨테이너로 성공적으로 배포되었습니다.
...
| **eDOCr2 v1 API** | 5001 | ✅ Healthy | 한글 OCR 처리 (Fast) |
| **eDOCr2 v2 API** | 5002 | ⚠️  Not Ready | 한글 OCR 처리 (Advanced) |
| **EDGNet API** | 5012 | ✅ Healthy | 도면 세그멘테이션 |
| **Skin Model API** | 5003 | ✅ Healthy | 공차 예측 및 제조 가능성 분석 |
| **YOLOv11 API** | 5005 | ✅ Healthy | 공학 도면 객체 검출 |
| **PaddleOCR API** | 5006 | ✅ Healthy | 다국어 OCR (GPU 가속) |
| **VL API** | 5004 | ✅ Healthy | 비전-언어 멀티모달 분석 |
