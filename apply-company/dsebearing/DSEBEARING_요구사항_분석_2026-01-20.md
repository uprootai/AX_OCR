...
> **프로젝트**: 터빈 베어링 관련 전달 자료 분석 및 견적 자동화
> **분석 상태**: ✅ **94개 전달 자료 분석 완료 (100%)**
...
| **품질 기준서** | 4개 | - | ✅ 완료 | TD0060732 1/4~4/4 |
| **부품 도면** | 87개 | ~100MB | ✅ 완료 | TD 시리즈 부품/조립 관련 도면 |
| **합계** | **94개** | **~145MB** | **94/94** | 1UNIT PJT 전달 자료 패키지 |

### 1.1-1 용어 주의

- `94개 PDF`는 고객이 전달한 전체 자료 수량을 의미함.
- 이 94개는 모두 동일한 성격의 도면이 아니며, BOM/사양서/품질기준서/부품 도면이 섞여 있음.
- 따라서 `94개 터빈 베어링 도면` 또는 `1UNIT PJT 전체 도면`이라는 표현은 이 문서 기준으로는 부정확함.
...
### 2.1 도면 샘플 요청 (완료)
- **요청**: 5~10장 샘플
- **실제 전달**: 94개 PDF 패키지 (`BOM 1 + 사양서 2 + 품질기준서 4 + 부품 도면 87`)
...
| 항목 | 상태 | 내용 |
|------|------|------|
| **전체 전달 자료 분석** | ✅ 완료 | 94개 PDF → 94개 MD 분석 파일 |
