...
- [심볼 검출](/pid-analysis/symbol-detection) — YOLO v11 기반 심볼 검출
- [연결성 분석](/pid-analysis/connectivity) — 라인과 심볼을 결합한 연결 그래프
- [설계 검사기](/pid-analysis/design-checker) — 영역 검출 기반 설계 검증
