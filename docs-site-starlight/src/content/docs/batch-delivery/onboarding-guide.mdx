...
- [배치 처리](/batch-delivery/batch-processing) — 온보딩 5단계에서 호출되는 배치 분석
- [프로젝트 관리](/batch-delivery/project-management) — 온보딩 1단계에서 생성되는 프로젝트 구조
- [내보내기 패키지](/batch-delivery/export-package) — 온보딩 8단계의 견적 내보내기
