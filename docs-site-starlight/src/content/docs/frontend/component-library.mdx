...
tags: [프론트엔드, React, 컴포넌트, 라이브러리]
---

# 컴포넌트 라이브러리 (Component Library)

> 69개 TSX 컴포넌트의 카테고리별 분류, BlueprintFlow 노드, UI 기본 컴포넌트, 스타일링 패턴을 설명합니다.
...
- [상태 관리](./state-management.mdx) -- Zustand 스토어 상세
- [라우팅](./routing.mdx) -- 페이지 라우트 및 레이아웃 구조
