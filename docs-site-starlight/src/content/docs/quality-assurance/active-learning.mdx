...
- [피드백 파이프라인](/docs/quality-assurance/feedback-pipeline) — 검증 완료 데이터의 YOLO 데이터셋 변환
- [GT 비교](/docs/quality-assurance/gt-comparison) — 정답 데이터와 비교 평가
- [에이전트 검증](/docs/agent-verification) — L2 Agent Review 연동
