...
- [GT 비교](/quality-assurance/gt-comparison) — 검출 결과의 정답 비교 평가
- [능동 학습](/quality-assurance/active-learning) — 불확실 샘플 우선 학습
- [피드백 파이프라인](/quality-assurance/feedback-pipeline) — 검증 데이터 수집 및 재학습
