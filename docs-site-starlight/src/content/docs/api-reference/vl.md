...
- [eDOCr2 API](/api-reference/edocr2) -- 추출된 치수를 VL로 검증
- [YOLO Detection API](/api-reference/yolo) -- 검출된 심볼을 VL로 확인
- [On-Premise Infrastructure](/deployment/on-premise-infra) -- 폐쇄망 환경에서 로컬 LLM 대체 방안
