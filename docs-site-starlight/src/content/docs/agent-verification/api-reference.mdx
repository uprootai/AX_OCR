...
# API 레퍼런스 (Verification API Reference)
...
| 메서드 | 엔드포인트 | 설명 |
|--------|-----------|------|
| GET/POST | `Gateway /verification/*` | 검증 API 전체 |

## 관련 문서

- [에이전트 검증](/docs/agent-verification/) -- 검증 시스템 개요
- [3단계 아키텍처](/docs/agent-verification/three-level-architecture) -- 신뢰도 임계값 및 우선순위 시스템
- [대시보드](/docs/agent-verification/dashboard) -- 검증 통계 및 지표
