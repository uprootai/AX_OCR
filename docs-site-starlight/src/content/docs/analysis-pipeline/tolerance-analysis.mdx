...
- [OCR 처리](/docs/analysis-pipeline/ocr-processing) -- 공차 분석에 입력되는 치수/GD&T 추출
- [BOM 및 견적](/docs/bom-generation/) -- 공차 분석 결과가 비용에 반영되는 구조
- [노드 카탈로그](/docs/blueprintflow/node-catalog) -- BlueprintFlow SkinModel 노드 파라미터
