...
- [VLM 분류](/docs/analysis-pipeline/vlm-classification) -- 검출 전 도면 유형 분류
- [OCR 처리](/docs/analysis-pipeline/ocr-processing) -- 검출 후 텍스트 추출
- [검출 클래스](/docs/bom-generation/detection-classes) -- 73개 검출 클래스 전체 목록
- [노드 카탈로그](/docs/blueprintflow/node-catalog) -- BlueprintFlow YOLO 노드 파라미터
