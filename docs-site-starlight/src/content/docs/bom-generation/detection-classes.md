...
tags: [BOM, 견적, 검출클래스, YOLO]
---

# 검출 클래스 (Detection Classes)

> BOM 생성, P&amp;ID 분석, 주석 검출에 사용되는 73개 이상의 YOLO v11 검출 클래스 목록입니다.
...
| 메서드 | 엔드포인트 | 설명 |
|--------|-----------|------|
| POST | `YOLO /api/v1/detect` | 27개 클래스 검출 |

## 관련 문서

- [BOM 및 견적](./index.mdx) -- 전체 파이프라인 개요
- [견적 엔진](./pricing-engine.mdx) -- 검출 결과 기반 원가 계산
- [YOLOv11 검출](../research/yolov11-detection.md) -- YOLO 모델 아키텍처 연구
