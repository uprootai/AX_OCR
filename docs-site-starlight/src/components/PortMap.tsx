...
const PORTS: PortEntry[] = [
  ...
  { port: 5006, name: 'PaddleOCR', category: 'ocr', gpu: true },
  ...
  { port: 5013, name: 'Surya OCR', category: 'ocr', gpu: true },
  { port: 5014, name: 'DocTR', category: 'ocr', gpu: true },
  { port: 5015, name: 'EasyOCR', category: 'ocr' },
  { port: 5016, name: 'Line Detector', category: 'segmentation', gpu: true },
...
export default function PortMap() {
  return (
    <div style={{ border: '1px solid var(--sl-color-gray-5)', borderRadius: '8px', padding: '16px' }}>
