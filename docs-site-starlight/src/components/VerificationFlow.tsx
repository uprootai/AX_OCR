...
export default function VerificationFlow() {
  return (
    <div style={{ padding: '16px', border: '1px solid var(--sl-color-gray-5)', borderRadius: '8px' }}>
      {/* Input */}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginTop: '12px' }}>
        ...
        <div style={{ padding: '16px', background: '#e8f5e9', border: '2px solid #4caf50', borderRadius: '12px', textAlign: 'center' }}>
          ...
          <div style={{ fontWeight: 700, fontSize: '1.1rem', color: '#1b5e20' }}>자동 승인</div>
          ...
          <div style={{ fontSize: '0.8rem', color: '#388e3c', marginTop: '6px' }}>전체의 ~80%</div>
          <div style={{ marginTop: '8px', fontSize: '0.75rem', color: '#666' }}>사람 개입 불필요</div>
        </div>
        ...
        <div style={{ padding: '16px', background: '#e3f2fd', border: '2px solid #2196f3', borderRadius: '12px', textAlign: 'center' }}>
          ...
          <div style={{ fontWeight: 700, fontSize: '1.1rem', color: '#0d47a1' }}>에이전트 검토</div>
          <div style={{ margin: '8px 0', padding: '4px 12px', background: 'white', borderRadius: '16px', display: 'inline-block', fontSize: '0.85rem', fontWeight: 600 }}>
            0.5 - 0.85
          </div>
          <div style={{ fontSize: '0.8rem', color: '#1976d2', marginTop: '6px' }}>Claude Sonnet Vision</div>
          <div style={{ marginTop: '8px', fontSize: '0.75rem', color: '#666' }}>승인 / 거부 / 에스컬레이션</div>
        </div>
        ...
        <div style={{ padding: '16px', background: '#fff3e0', border: '2px solid #ff9800', borderRadius: '12px', textAlign: 'center' }}>
          ...
          <div style={{ fontWeight: 700, fontSize: '1.1rem', color: '#bf360c' }}>사람 검토</div>
          <div style={{ margin: '8px 0', padding: '4px 12px', background: 'white', borderRadius: '16px', display: 'inline-block', fontSize: '0.85rem', fontWeight: 600 }}>
            신뢰도 &lt; 0.5
          </div>
          <div style={{ fontSize: '0.8rem', color: '#e65100', marginTop: '6px' }}>복잡 / 불확실 항목</div>
          <div style={{ marginTop: '8px', fontSize: '0.75rem', color: '#666' }}>키보드 단축키 (A/R/S)</div>
        </div>
      </div>
