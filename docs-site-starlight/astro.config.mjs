            ...
            },
            {
                ...
                items: [
                        ...
                        items: [
                            ...
                            { label: '다음 단계 & 미결 사항', slug: 'customer-cases/dsebearing/next-steps' },
                            {
                                ...
                                items: [
                                    ...
                                    { label: 'GT 검증 (7건)', slug: 'customer-cases/dsebearing/ensemble/gt-validation' },
                                ],
                            },
                            {
                                label: 'E12 — ASSY 검증 (v7 90%)',
                                collapsed: true,
                                items: [
                                    { label: '세션명 힌트 보정', slug: 'customer-cases/dsebearing/e12-session-hint' },
                                    { label: 'SECTION 단면도 감지', slug: 'customer-cases/dsebearing/e12-section-detection' },
                                    { label: '멀티뷰 감지', slug: 'customer-cases/dsebearing/e12-view-detection' },
                                ],
                            },
                            {
                                label: '검출 방법론 실험',
                                collapsed: true,
                                items: [
                                    { label: '종합 비교', slug: 'customer-cases/dsebearing/experiments' },
                                    {
                                        label: '텍스트 기반 (앙상블 기여)',
                                        items: [
                                            { label: 'S01 — 화살촉', slug: 'customer-cases/dsebearing/experiments/s01-arrowhead' },
                                            { label: 'S02 — Text-First', slug: 'customer-cases/dsebearing/experiments/s02-text-first' },
                                            { label: 'S06 — YOLO-OBB', slug: 'customer-cases/dsebearing/experiments/s06-yolo' },
                                        ],
                                    },
                                    {
                                        label: '원 검출 (ASSY 한계)',
                                        items: [
                                            { label: 'S03 — RHT', slug: 'customer-cases/dsebearing/experiments/s03-rht' },
                                            { label: 'S04 — Ellipse', slug: 'customer-cases/dsebearing/experiments/s04-ellipse' },
                                            { label: 'S05 — CircleNet (보류)', slug: 'customer-cases/dsebearing/experiments/s05-circlenet' },
                                            { label: 'S08 — Cardinal', slug: 'customer-cases/dsebearing/experiments/s08-cardinal' },
                                        ],
                                    },
                                    {
                                        label: 'VLM / 외부 검증',
                                        items: [
                                            { label: 'S07 — Florence-2 (보류)', slug: 'customer-cases/dsebearing/experiments/s07-florence2' },
                                            { label: 'Codex 교차검증', slug: 'customer-cases/dsebearing/experiments/codex-validation' },
                                        ],
                                    },
                                ],
                            },
                            {
                                ...
                                items: [
                                    ...
                                    { label: 'Casing — 단품 사례', slug: 'customer-cases/dsebearing/pipeline/casing' },
                                ],
                            },
                        ],
                    },
                    { label: '파나시아 — MCP Panel', slug: 'customer-cases/panasia' },
                    {
                        ...
                        collapsed: true,
                        items: [
                            { label: '프로젝트 개요', slug: 'customer-cases/bmt' },
                            { label: '자료 분석', slug: 'customer-cases/bmt/data-analysis' },
                            { label: 'POC 테스트 결과', slug: 'customer-cases/bmt/poc-results' },
                            { label: '전체 자료 비교', slug: 'customer-cases/bmt/full-comparison' },
                            { label: '데이터 검증 이슈', slug: 'customer-cases/bmt/verification-issues' },
                            { label: '다음 단계', slug: 'customer-cases/bmt/next-steps' },
                            { label: '고객 확인 현황', slug: 'customer-cases/bmt/customer-confirmations' },
                            { label: '2차 통화 분석 (03-25)', slug: 'customer-cases/bmt/call-20250325' },
                            { label: '실데이터 대조 분석', slug: 'customer-cases/bmt/call-analysis-detail' },
                            { label: 'S01 — OCR 벤치마크', slug: 'customer-cases/bmt/s01-ocr-benchmark' },
                            { label: 'S02 — 뷰별 분리', slug: 'customer-cases/bmt/s02-view-segmentation' },
                            { label: 'S03+S04 — BOM 매칭', slug: 'customer-cases/bmt/s03-s04-bom-matching' },
                            { label: 'S05 — Claude Vision GT', slug: 'customer-cases/bmt/s05-vlm-gt' },
                            { label: 'S06 — BlueprintFlow 템플릿', slug: 'customer-cases/bmt/s06-blueprintflow' },
                            { label: 'E10 — 테스트 결과', slug: 'customer-cases/bmt/e10-test-results' },
                            { label: 'E11 — 뷰 자동 분리 (100%)', slug: 'customer-cases/bmt/e11-auto-view' },
                            { label: 'E11 — Min-Content 경계', slug: 'customer-cases/bmt/e11-mincontent' },
                            { label: 'E11 — E2E 파이프라인', slug: 'customer-cases/bmt/e11-e2e-pipeline' },
                        ],
                    },
                ],
            },
