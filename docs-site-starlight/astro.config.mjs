                ...
                items: [
                    { label: '개요', slug: 'customer-cases' },
                    {
                        ...
                        items: [
                            ...
                            { label: '전달 자료 & 도면', slug: 'customer-cases/dsebearing/data-overview' },
                            { label: '미팅 기록', slug: 'customer-cases/dsebearing/meeting-history' },
                            { label: '추출 & 견적 결과', slug: 'customer-cases/dsebearing/results' },
                            { label: '다음 단계', slug: 'customer-cases/dsebearing/next-steps' },
                        ],
                    },
