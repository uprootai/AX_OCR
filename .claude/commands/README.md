...
### `/handoff` ⭐ NEW - 세션 핸드오프
컨텍스트 윈도우 60% 이상 시 안전한 세션 전환을 위한 명령입니다.
...
- 수정된 파일 목록
- 미완료 작업 및 다음 단계
- `.claude/handoff/` 디렉토리에 저장

**사용 시기**:
- `/context` 명령으로 60% 이상 확인 시
- 복잡한 작업 전환 전
- 컨텍스트 부패 징후 시 (응답 품질 저하)
...
- **온디맨드 가이드**: `.claude/skills/` 참조

---

**마지막 업데이트**: 2026-01-16
**버전**: 3.0.0 (handoff 명령 추가)
