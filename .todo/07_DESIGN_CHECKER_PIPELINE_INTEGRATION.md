...
### 4.1 단위 테스트
- [ ] `tests/test_yolo_service.py` - YOLO 서비스 테스트
- [ ] `tests/test_edocr2_service.py` - eDOCr2 서비스 테스트
- [ ] `tests/test_pipeline_router.py` - 파이프라인 라우터 테스트

### 4.2 통합 테스트
- [ ] `tests/test_pipeline_integration.py` - YOLO + eDOCr2 통합 테스트
