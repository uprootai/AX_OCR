...
**작업 항목**:
- [x] yolo-api에 svg_generator.py 추가 ✅ (235줄, 2026-01-16 확인)
- [x] detection_router.py에 include_svg 파라미터 추가 ✅ (2026-01-16 확인)
- [x] 프론트엔드 YOLOVisualization 컴포넌트 수정 ✅ (SVG 모드 토글, 2026-01-16)
...
**작업 항목**:
- [x] line-detector-api에 svg_generator.py 추가 ✅ (350줄, 2026-01-16 확인)
- [x] 라인 스타일별 SVG 스타일 정의 ✅ (LINE_STYLE_COLORS 포함)
- [x] include_svg 파라미터 추가 ✅ (generate_line_svg 함수 지원)
...
**작업 항목**:
- [x] edocr2-api에 svg_generator.py 추가 ✅ (2026-01-17)
- [x] 텍스트 카테고리별 스타일 적용 ✅ (2026-01-17)
- [x] paddleocr에 동일 패턴 적용 ✅ (2026-01-17)
- [ ] tesseract 등에도 동일 패턴 적용
...
| 작업 | 우선순위 | 예상 작업량 | 상태 | 의존성 |
|------|----------|-------------|------|--------|
| 공통 SVG 유틸리티 | P0 | 2시간 | ✅ 완료 | 없음 |
| YOLO SVG 확장 | P1 | 3시간 | ✅ 완료 | 공통 유틸리티 |
| Line Detector SVG | P1 | 2시간 | ✅ 완료 | 공통 유틸리티 |
| OCR SVG 확장 (eDOCr2, PaddleOCR) | P2 | 3시간 | ✅ 완료 (2026-01-17) | 공통 유틸리티 |
| Blueprint AI BOM 연동 | P2 | 4시간 | 대기 | YOLO SVG |
| 제네릭 OverlayViewer | P2 | 4시간 | 대기 | 모든 SVG 완료 |
