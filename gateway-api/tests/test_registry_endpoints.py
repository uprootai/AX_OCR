...
class TestRegistryListEndpoint:
    ...
    def test_get_registry_list_empty(self, client):
        """빈 레지스트리 조회 테스트"""
        # Reset registry
        import api_registry
    ...
    def test_get_registry_list_with_apis(self, client, sample_api_metadata):
...
class TestRegistryHealthyEndpoint:
    ...
    def test_get_healthy_apis_empty(self, client):
        """Healthy API 없을 때 조회 테스트"""
        # Reset registry
        import api_registry
        api_registry._api_registry = None

        response = client.get("/api/v1/registry/healthy")
    ...
    def test_get_healthy_apis_filtered(self, client, sample_api_metadata):
...
class TestRegistryGetAPIEndpoint:
    ...
    def test_get_api_by_id_success(self, client, sample_api_metadata):
        """API ID로 조회 성공 테스트"""
        # Reset and populate registry
        import api_registry
        api_registry._api_registry = None
        ...
        response = client.get("/api/v1/registry/test-api")
    ...
    def test_get_api_by_id_not_found(self, client):
        """존재하지 않는 API 조회 테스트"""
        # Reset registry
        import api_registry
        api_registry._api_registry = None
...
class TestRegistryCategoryEndpoint:
    ...
    def test_get_apis_by_category_success(self, client, sample_api_metadata):
        """카테고리별 API 조회 성공 테스트"""
        # Reset and populate registry
        import api_registry
        api_registry._api_registry = None
        ...
        response = client.get("/api/v1/registry/category/ocr")
    ...
    def test_get_apis_by_category_empty(self, client):
        """존재하지 않는 카테고리 조회 테스트"""
        # Reset registry
        import api_registry
        api_registry._api_registry = None

        response = client.get("/api/v1/registry/category/nonexistent")
...
class TestRegistryEdgeCases:
    ...
    def test_registry_endpoint_route_ordering(self, client, sample_api_metadata):
        """
        라우트 순서 테스트
    ...
    def test_multiple_concurrent_requests(self, client, sample_api_metadata):
        """동시 요청 처리 테스트"""
        # Reset and populate registry
        import api_registry
        api_registry._api_registry = None
    ...
    def test_registry_persistence_across_requests(self, client, sample_api_metadata):
        ...
        # First request
        response1 = client.get("/api/v1/registry/list")
        assert response1.status_code == 200
        assert response1.json()["total_count"] == 1

        # Second request should see same data
        response2 = client.get("/api/v1/registry/list")
