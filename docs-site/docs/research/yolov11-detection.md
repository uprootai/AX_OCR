...
- [검출 클래스](../bom-generation/detection-classes.md) -- AX 시스템의 73개 검출 클래스 목록
- [BOM 및 견적](../bom-generation/index.mdx) -- YOLO 검출이 사용되는 BOM 파이프라인
- [Qwen2-VL](./qwen2-vl.md) -- 도면 분류에 사용되는 VLM
