...
- [DocTR API](/docs/api-reference/doctr) - DocTR API 서비스 (Port 5014)
- [OCR Ensemble Voting](/docs/research/ocr-ensemble-voting) - 다중 OCR 엔진 앙상블 방법론
- [EasyOCR](/docs/research/easyocr) - 범용 OCR 프로젝트
- [PaddleOCR](/docs/research/paddleocr) - PP-OCR 경량 OCR 시스템
- [TrOCR](/docs/research/trocr-transformer) - Transformer 기반 OCR
