...
def create_background_image_with_boxes_cached(image_array, detections_data, verification_status_hash):
    ...
    for det_info in detections_data:
        bbox = det_info['bbox']
        ...
        cv2.rectangle(background_img, (x1, y1-20), (x1+label_size[0], y1), color, -1)
        cv2.putText(background_img, class_name, (x1, y1-5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
